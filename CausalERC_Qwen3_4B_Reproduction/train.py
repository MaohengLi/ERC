...
def main():
    ...
    for epoch in range(1,a.epochs+1):
        ...
        for step in range(0,len(train),a.batch_size):
            ...
            o=model(initial,initial["labels"],tokenizer=tok,dialogues=ds,max_length=a.max_length,history_window=a.history_window); (o["loss"]/a.grad_accumulation).backward(); total+=float(o["loss"]); pred+=o["logits"].argmax(-1).detach().cpu().tolist(); y+=initial["labels"].cpu().tolist()
